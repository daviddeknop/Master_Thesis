...
run_dir = Path(parent_wd / 'runs/...') # fill in with your created output file
base_dir = Path(parent_wd / 'runs/...') # fill in with your created output file
...
with open(run_dir / "test" / "model_epoch..." / "test_results.p", "rb") as fp: # fill in with your best epoch
