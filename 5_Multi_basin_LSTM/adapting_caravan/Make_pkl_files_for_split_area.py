...
input_file = parent_pad / "folder_names_filtered.txt"

output_file = "per_basin_train_periods_area_filtered.pkl"
...
output_file = "per_basin_validation_periods_area_filtered.pkl"
# Define time periods
...
# Define file paths
input_file = parent_pad / "Zwalm_code.txt"
...
# Define file paths
input_file = parent_pad / "Bellebeek_code.txt"

output_file = "train_Bellebeek.pkl"
...
# Define the path to the NetCDF file
input_file = parent_pad / "folder_names.txt"

output_file = "per_basin_train_periods_area.pkl"
...
output_file = "per_basin_validation_periods_area.pkl"
# Define time periods
default_period = [["25/11/2012", "31/12/2022"]]
special_period = [["25/11/2012", "14/12/2017"]]
