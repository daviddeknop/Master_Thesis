...
area = 111639970.52
#evaluate model
run_dir = Path('runs/CARAVAN_Basins_1002_124541')
for i in range(1, 21):
    eval_run(epoch = i,run_dir=run_dir, period="test")

# Base directory containing the test results
base_dir = Path('runs/CARAVAN_Basins_1002_124541/test')
...
with open(run_dir / "test" / "model_epoch011" / "test_results.p", "rb") as fp:
