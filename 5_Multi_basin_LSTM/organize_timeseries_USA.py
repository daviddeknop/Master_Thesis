...
source_folder = Path('output_caravan_US/timeseries/netcdf/camels') 
...
def organize_nc_files(source_folder):
    ...
    for file_name in os.listdir(source_folder):
        ...
        if file_name.startswith("camels_") and file_name.endswith(".nc"):
            # Haal het serienummer uit de bestandsnaam
            series_number = file_name.split("_")[1].split(".")[0]
            
            if series_number.startswith('0'):
                series_number = '9' + series_number[1:]
